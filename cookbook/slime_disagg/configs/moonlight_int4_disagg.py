...
The cheap de-risk rung for `kimi_k2_6_int4_disagg`. Moonlight-16B-A3B is the same
...
then `kimi_k2_6_int4_disagg` changes only scale and the serving image.
...
Deploy as its own app:
    EXPERIMENT_CONFIG=moonlight_int4_disagg m deploy --strategy recreate -m cookbook.slime_disagg.modal_train
...
APP_NAME = "slime-moonlight-int4-disagg"
DELTA_VOLUME_NAME = "slime-delta-bulletin-moonlight-int4"
