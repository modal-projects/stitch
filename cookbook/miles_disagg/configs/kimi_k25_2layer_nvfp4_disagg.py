...
here, then run the full kimi_k2_6_nvfp4_disagg once it's clean.

    EXPERIMENT_CONFIG=kimi_k25_2layer_nvfp4_disagg \
      uv run --extra modal modal run --detach -m cookbook.miles_disagg.modal_train::prepare_checkpoints
    EXPERIMENT_CONFIG=kimi_k25_2layer_nvfp4_disagg \
      uv run --extra modal modal run --detach -m cookbook.miles_disagg.modal_train::prepare_torch_dist
    EXPERIMENT_CONFIG=kimi_k25_2layer_nvfp4_disagg \
...
APP_NAME = "miles-kimi-k25-2layer-nvfp4-disagg"
DELTA_VOLUME_NAME = "miles-delta-bulletin-kimi-k25-2layer"
