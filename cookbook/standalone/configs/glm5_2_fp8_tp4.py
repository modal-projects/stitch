...
holds ~597K KV tokens; on the benchmarked ~33K-token agentic mix, 16 concurrent
users ran at 94% KV occupancy and 12 at ~54%, so engine admission stops at 16
while the router targets 12.
"""
...
# (glm-5-2-fp8-dflash-bf16kv-s103k-b300x4), benchmarked on an 82-trajectory
# agentic mix: 728 output tok/s at its 16-user ceiling, p50 E2E 1.6s.
SGLANG_SERVER_ENV = {
...
SGLANG_SERVER_ARGS = {
    ...
    **DFLASH_SERVER_ARGS,
    # memory / batching: 0.90 static leaves ~9.6 GB/GPU after CUDA graphs,
